...
class HBNBCommand(cmd.Cmd):
    ...
    def format_create(params):
        """ helper function to format params
        ...
        for param in params:
            ...
            if value[0] == '\"' and value[-1] == '\"':
                ...
                value = int(value)
            elif HBNBCommand.is_float(value):
                value = float(value)
            else:
                pass
    ...
    def do_create(self, args):
        ...
        if class_type not in HBNBCommand.classes:
            ...
            return
        new_instance = HBNBCommand.classes[class_type]()
        params = args[1:]
        formatted_params = HBNBCommand.format_create(params)
